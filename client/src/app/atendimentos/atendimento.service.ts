...
export class AtendimentoService {
	...
	constructor(http: Http, private serviceAluno: AlunoService, private serviceProfessor: ProfessorService) {
	...
	listByAluno(alunoId: string): Atendimento[] {
		...
		return atendimentos.filter(a => a.aluno ? (a.aluno._id === alunoId) : false);
	}
